...
public class FriendshipServiceImpl implements FriendshipService {
  ...
  @Override
  public Optional<Friendship> findFriendShipByUser1AndUser2(
    String email1,
    String email2
  ) {
  ...
  public boolean ifFriendshipExists(String email1, String email2) {
    if (
      findFriendShipByUser1AndUser2(email1, email2).isEmpty() &&
      findFriendShipByUser1AndUser2(email2, email1).isEmpty()
    ) {
      return false;
    } else {
      return true;
  ...
  public void addFriendship(Friendship friendship) {
    if (ifFriendshipExists(friendship.getEmail1(), friendship.getEmail2())) {
